...
#ifdef USE_HMM
typedef LogAddress lmn_data_t;
#else
typedef value_t lmn_data_t;
#endif
...
static inline lmn_word lmn_hash(lmn_word val);

lmn_word lmn_hash(lmn_word val) {
